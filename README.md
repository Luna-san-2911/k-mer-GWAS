...
Files in this repository with suffix .sh are generated by KMERIA, I only added some notes.
...
1. Short-reads
   ...
   Moreover, do not use "_" for your sample names, this could less to sample mistaching when running the pipeline
