...
This pipeline is based on K-meria (https://www.researchsquare.com/article/rs-7347406/v1) + some issues fixed that I found while running the pipeline + extra scripts and notes
